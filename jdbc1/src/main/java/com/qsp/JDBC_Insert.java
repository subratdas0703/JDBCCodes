...
//			Connection conn=DriverManager.getConnection(url);
			...
			//step4
			boolean res=stmt.execute("insert into employee values(7369,'SMITH','CLERK',3000,20),(7499,'ALLEN','SALESMAN',2000,30),(7521,'WARD','SALESMAN',1250,30),(7566,'JONES','MANAGER',2975,20),(7654,'MARTIN','SALESMAN',1250,10)");
